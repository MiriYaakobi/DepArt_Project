...
public static class Initialization
{
    ...
    private static void createOrders()
    {
        ...
        var addresses = new (string address, double latitude, double longitude)[]
        {
            ...
            ("Modi'in - Lev HaIr St", 31.8989, 35.0078), ("Ashdod - HaGdud HaIvri St", 31.8044, 34.6553),
            ("Beersheba - David Tuviyahu Blvd", 31.2518, 34.7915), ("Rehovot - Bilu St", 31.8948, 34.8110)
        };
        ...
        for (int i = 0; i < 50; i++)
        {
            ...
            OrderType typeOfOrder = (OrderType)s_rand.Next(0, 3);
            ...
            bool isLate = s_rand.NextDouble() < 0.4;

            DateTime orderOpeningTime;

            if (isLate)
            {
                orderOpeningTime = DateTime.Now.AddDays(-(maxDeliveryDays + s_rand.Next(1, 10)));
            }
            else
            {
                orderOpeningTime = DateTime.Now.AddDays(-s_rand.Next(0, maxDeliveryDays));
            }
