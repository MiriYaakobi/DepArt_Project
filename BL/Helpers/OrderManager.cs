...
//                try
//                {
//                    // שינוי: שימוש ב-await לפונקציית החישוב האסינכרונית
...
//        // שינוי: קריאה אסינכרונית לחישוב המרחק והזמן
...
internal static class OrderManager
{
    ...
    {
        // 1. Check Mutex to prevent overlapping executions
        ...
        try
        {
            ...
            // 5. Call CreateOrderAsync
            // Note: We do NOT need to add lock() here because CreateOrderAsync 
            // already wraps the DAL call in lock(AdminManager.BlMutex) internally.
            // Also, CreateOrderAsync handles the notifications internally.
